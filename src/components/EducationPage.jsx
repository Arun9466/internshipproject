      ...
      <h3>Tenth details</h3>
        <div>
          ...
          <input
            ...
            value={educationData.tenth_schoolname}
        ...
        <div>
          ...
          <input
            ...
            value={educationData.tenth_school_city}
            onChange={handleChange}
            required
          />
        </div>
        <div>
          ...
          <input
            ...
            value={educationData.tenth_pass_year}
            onChange={handleChange}
            required
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            id="college_city"
            name="college_city"
            value={educationData.college_city}
            onChange={handleChange}
            required
          />
        </div>
        <div>
          ...
          <input
            ...
            value={educationData.twelth_pass_year}
            onChange={handleChange}
            required
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            value={educationData.degree_collegename}
            onChange={handleChange}
            required
          />
        </div>
        <div>
          ...
          <input
            ...
            value={educationData.degree_collegeplace}
            onChange={handleChange}
            required
          />
        </div>
